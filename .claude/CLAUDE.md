...
PADDLE_ENVIRONMENT / PADDLE_API_KEY / PADDLE_WEBHOOK_SECRET / PADDLE_PRICE_MONTHLY / PADDLE_PRICE_YEARLY
...
NEXT_PUBLIC_PADDLE_ENVIRONMENT / NEXT_PUBLIC_PADDLE_CLIENT_TOKEN: Paddle.js runs in the browser,
  so these two remain build-time inlined — public instance only.
```
